...
class Arcade extends CI_Controller {
    ...
    function index() {
		    	...
		    	$data['main_content'] = 'arcade/mainPage.php';
    ...
    function won() {
    	...
    	$this->user_model->updateStatus($user->id, User::AVAILABLE);
    	$_SESSION['myturn'] = false;
    	$data['main_content'] = 'arcade/won.php';
    	$this->load->view('main.php', $data);
    }
    ...
    function lost() {
    	...
    	$this->user_model->updateStatus($user->id, User::AVAILABLE);
    	$_SESSION['myturn'] = false;
    	$data['main_content'] = 'arcade/lost.php';
    	$this->load->view('main.php', $data);
    }
    ...
    function tie() {
    	...
    	$this->user_model->updateStatus($user->id, User::AVAILABLE);
    	$_SESSION['myturn'] = false;
    	$data['main_content'] = 'arcade/tie.php';
    	$this->load->view('main.php', $data);
    }
